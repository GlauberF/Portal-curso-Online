<?php
	...
	if(isset($_REQUEST['action'])){
		switch ($_REQUEST['action']) {
			case "edit":
				$cad = new Control();
				$cad->editAluno($_POST['idaluno'], $_POST['nome'], $_POST['email'], $_POST['tel'], $_POST['cel'], $_POST['endereco'], $_POST['complemento'], $_POST['bairro'], $_POST['cep'], $_POST['cidade'], $_POST['estado']);
			break;
			case "senha":
				$cad = new Control();
				$cad->senha($_POST['idaluno'], $_POST['senha']);
			break;			
		}
	}	
	...
	<div id="wrapper">
		...
		<div id="head">
			...
			<div id="menus_wrapper">
				...
				<div id="sec_menu">
					<ul>
						<li><a href="conta.php" class="sm5">Voltar</a></li>						
					</ul>				
				</div>
			</div>
		</div>
									...
									<div class="sct_right">
										<div class="sct_left">
											<div class="sct_right">
												...
												<form id="alunoIN" action="?action=edit" method="POST" class="search_form general_form">
													<fieldset>
														<div class="forms">
															<div class="row">
																<label>Nome:</label>
															...
															<div class="row">
																<label>Cpf:</label>
																<div class="inputs">
																	<span class="input_wrapper"><input class="text" name="cpf" disabled id="cpf" value="<?=$arr[$i]->cpf['cpf']?>" type="text" /></span>
																	<span class="system negative"></span>
																</div>
															</div>															
															<div class="row">

<?php
	...
	if(isset($_REQUEST['action'])){
		switch ($_REQUEST['action']) {
			case "in":
				$cad = new Control();
				$cad->cadConcurso($_POST["nome"], $_POST["descricao"], $_POST["remuneracao"], $_POST["vagas"], $_POST['cliente_idcliente']);
			break;
			case "edit":
				$cad = new Control();
				$cad->editConcurso($_POST["idconcurso"], $_POST["nome"], $_POST["descricao"], $_POST["remuneracao"], $_POST["vagas"], $_POST['cliente_idcliente']);
			break;
			case "out":
				$cad = new Control();

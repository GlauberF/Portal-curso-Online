<?php
	...
	if(isset($_REQUEST['action'])){
		switch ($_REQUEST['action']) {
			case "in":
				$cad = new Control();
				$cad->cadMaterial($_POST["nome"], $_FILES["endereco"], $_POST["descricao"], $_POST["aula_idaula"], $_POST["cliente_idcliente"]);
			break;
			case "edit":
				$cad = new Control();
			...
			case "arq":
				$cad = new Control();
				$cad->Arquivo($_POST["idmaterial"], $_FILES["endereco"], $_POST["cliente_idcliente"]);
			break;			
		}
	}

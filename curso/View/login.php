<?php
	...
	if(isset($_REQUEST['action'])){
		switch ($_REQUEST['action']) {
			case "ax":
				$cad = new Control();
				$cad->entraLogin($_POST["email"], $_POST["password"]);
			break;
		}
	}
?>
...
<title>Circle Tecnologia - Admin</title>
<link media="screen" rel="stylesheet" type="text/css" href="media/css/admin-login.css"  />
		...
		<div id="login_wrapper">
			...
			<form action="<?=$_SERVER['PHP_SELF']; ?>?action=ax" method="POST">
				<fieldset>
					...
					<h1 id="logo"><a href="#">Painel administrativo Cicle tecnologia!!</a></h1>
					<div class="formular">
						...
						<ul class="form_menu">
							...
							<li><input type="button" onClick="parent.location='help.php'" value="Esqueceu a senha"></li>
						</ul>

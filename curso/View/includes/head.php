...
<style type="text/css" title="currentStyle">
	...
	#sortable2 { list-style-type: none; margin: 0; padding: 0; margin-right: 10px; background: #eee; padding: 5px; width: 143px;}
...
<script type="text/javascript">
	$(function(){
		...
		$("#data_entrada").datepicker(pickerOpts);
		$("#data_saida").datepicker(pickerOpts);
		$("#date_bd_backup").datepicker(pickerOpts);
		$("#date_file_backup").datepicker(pickerOpts);
	});
</script>
-->
...
<script type="text/javascript">
	$(document).ready( function() {	
		$('#fileTreeDemo_1').fileTree({ root: 'aulas/<?=$_SESSION['FolderCliente']?>/', script: 'includes/jqueryFileTree.php' }, function(file) { 
			addcat(file);
		});			
	});
</script>

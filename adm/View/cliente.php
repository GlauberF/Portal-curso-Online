														...
														<table cellpadding="0" cellspacing="0" border="0" class="display" id="example" width="100%">
															...
															<tbody>
																...
																<tr class="<? if($i % 2){ echo TABLE1; }else{ echo TABLE2; }?>">
																	<td>#<?=$arr[$i]->idcliente['idcliente']?></td>
																    <td><?=$arr[$i]->nome['nome']?></td>
																	<td><?=$arr[$i]->email['email']?></td>
																	<td><?=$arr[$i]->telefone['telefone']?></td>
																	<td><?=$arr[$i]->ativo['ativo']?'Ativo':'Não ativo'?></td>																	
																	<td>
																		<div class="actions">
																			<ul>
																				<li><a class="action2" href="vi_cliente.php?ed=<?=$arr[$i]->idcliente['idcliente']?>">2</a></li>
																				<!--<li><a class="action4" href="estabelecimento.php?action=out&nu=" onClick="return confirm('Deletar o estabelecimento ?')">4</a></li> -->
																			</ul>
																		</div>
																	</td>
																</tr>
										...
										<div class="sct_left">
											<div class="sct_right">
												<ul class="sidebar_menu">
													<li><a href="cad_cliente.php">Cadastrar novo cliente</a></li>
												</ul>
											</div>
										</div>
									</div>

<?php
	...
	if(isset($_REQUEST['action'])){
		switch ($_REQUEST['action']) {
			case "edit":
				$cad = new Control();
				$cad->editConfiguracao($_POST["id"], $_POST["email"], $_POST["emailnews"], $_POST["smtp"], implode("-",array_reverse(explode("/",$_POST["bdbackup"]))), implode("-",array_reverse(explode("/",$_POST["filebackup"]))), $_POST["smtppass"], $_POST["cliente_idcliente"]);
			break;
			case "cad":
				$cad = new Control();
				$cad->cadConfiguracao($_REQUEST["ed"]);
			break;			
		}
	}
	...
	<div id="wrapper">
		...
		<div id="head">
			...
			<div id="menus_wrapper">
				<div id="main_menu">
					<ul>
						<li><a href="online.php"><span><span>Home</span></span></a></li>
						<li><a class="selected" href="#"><span><span>Curso-online</span></span></a></li>						
										...
										<div class="sct_left">
											<div class="sct_right">
												<?php
													...
													if(!count($arr)){
														echo "Esse cliente não me parece estar cadastrado na base de configuração. <a href=\"config.php?action=cad&ed=".$_GET['ed']."\">Configurar?</a>";																																																																						
													}
														...
														<div class="forms">
															<div class="row">
																...
																<div class="inputs">
																	...
																	<input class="text" name="cliente_idcliente" id="cliente_idcliente" value="<?=$arr[$i]->cliente_idcliente['cliente_idcliente']?>" type="hidden" />
																</div>
															</div>
															<div class="row">
